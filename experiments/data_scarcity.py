...
def main(args):
    ...
    # print(f"Finetune test : {args.finetune}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--window_stride", type=int, default=2048)
    ...
    #     SSL
    #     ssl_method="sap",          # "sap" ou "mae"
    #     pretrain_dataset="CWRU",

    #     Downstream dataset
    #     dataset="CWRU",
    #     data_ratio=0.05,           # petit ratio pour debug

    #     Probing
    #     head_type="linear",        # "linear" ou "non-linear"
    #     finetune=False,            # True si tu veux tester le finetune
    ...
    #     Training
    #     seed=0,
    #     epochs=5,                  # petit nombre d'epochs pour debug
    #     batch_size=16,             # batch réduit pour PC
